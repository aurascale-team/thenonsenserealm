...
export function Footer({ isDark, onNavigate }: FooterProps) {
  const mutedColor = isDark ? 'rgba(255,248,240,0.45)' : 'rgba(42,14,0,0.5)'
  const borderColor = isDark ? 'rgba(193,68,14,0.2)' : 'rgba(193,68,14,0.12)'
  ...
  return (
    <footer
      ...
      style={{
        borderColor,
        background: isDark ? 'rgba(26,9,0,0.85)' : 'rgba(255,248,240,0.85)',
      }}
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          <NonsenseLogo size="md" />
          <p className="mt-4 text-sm leading-relaxed" style={{ color: mutedColor, fontFamily: "'Lora', serif", fontStyle: 'italic' }}>
        ...
        <div>
          <h4 className="font-heading text-xs tracking-widest uppercase mb-4" style={{ color: '#c1440e' }}>Contact</h4>
          ...
          <p className="text-xs mt-6" style={{ color: isDark ? 'rgba(255,248,240,0.25)' : 'rgba(42,14,0,0.3)' }}>
